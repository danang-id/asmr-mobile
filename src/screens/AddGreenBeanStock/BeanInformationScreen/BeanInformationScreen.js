...
type BeanInformationScreenProps = NativeStackScreenProps<
	...
	AddGreenBeanStockRoutes.BeanInformation,
>;
...
const BeanInformationScreen: FC<BeanInformationScreenProps> = ({navigation, route}) => {
	...
	function onInputBeanToInventoryButtonPressed() {
		Alert.alert('Yes sir!', 'Feature not available at the moment.');
	}
	...
	return (
		<SafeAreaView style={BeanInformationScreenStyle.container}>
			<ScrollView
				...
				<Button onPress={onInputBeanToInventoryButtonPressed}>Input This Bean to Inventory</Button>
			</ScrollView>
		</SafeAreaView>
	);
};
