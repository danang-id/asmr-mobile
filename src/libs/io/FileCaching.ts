...
class FileCaching {
	private static tag = FileCaching.name;
	private static getResourceId = (resourceUrl: string) => resourceUrl.substring(resourceUrl.lastIndexOf('/') + 1);
	private static getResourcePath = (resourceUrl: string) =>
